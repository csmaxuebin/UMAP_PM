...
t0 = time()
n_component=3
reducer2 = UMAP(n_neighbors=15, n_components=n_component,n_epochs=200,min_dist=0.1, local_connectivity=2, random_state=42)
...
total_time=time() - t0
write_list1 = [esp,n_component,accuracy,total_time]
print(write_list1)
